...
new-apps = Nya program
recently-updated = Nyligen uppdaterade
...
remove = Ta bort
removing = Tar bort...
place-applet = Placera miniprogram
place-applet-desc = Välj vart miniprogrammet ska läggas till innan dess position finjusteras.
panel = Panel
dock = Docka
...
translate = Översätt
cancelled = Avbruten
enable-flathub-cosmic = Slå på Flathub och COSMIC Flatpak för att se tillgängliga miniprogram.
