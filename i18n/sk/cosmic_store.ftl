...
checking-for-updates = Kontroluje sa dostupnosť aktualizácií...
close = Zavrieť
install = Inštalovať
...
place-on-desktop = Umiestniť na plochu
place-applet = Umiestniť miniaplikáciu
place-applet-desc = Vyberte, kam chcete pridať miniaplikáciu pred jej presným umiestnením.
panel = Panel
dock = Dock
...
codec-footer =
    ...
    Musíte overiť, že platí jedno z nasledujúceho:
     • Tieto obmedzenia sa na vás nevzťahujú podľa krajiny vášho pobytu
     • Máte povolenie používať tento softvér (napríklad licenciu na patent)
...
game = Hrať
relax = Relaxovať
socialize = Socializovať sa
utilities = Nástroje
applets = Miniaplikácie
...
productivity-apps = Produktívne aplikácie
graphics-and-photography-tools = Grafické & fotografické nástroje
social-networking-apps = Sociálne siete
games = Hry
...
no-custom-flatpak-sources = Žiadne vlastné zdroje Flatpak
import = Importovať
no-flatpak = Žiadna podpora flatpak
