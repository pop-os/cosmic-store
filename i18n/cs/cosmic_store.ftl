...
place-on-desktop = Přidat na plochu
place-applet = Přidat applet
place-applet-desc = Vyberte, kam chcete přidat applet, než upravíte jeho přesné umístění.
panel = Panel
dock = Dok
place-and-refine = Přidat a upravit
...
uninstall-app-warning = Odinstalace { $name } smaže její data.
explore = Objevovat
create = Tvorba
work = Práce
develop = Vývoj
...
music-and-video-apps = Aplikace pro hudbu a videa
...
recommended-flatpak-sources = Doporučené zdroje pro Flatpak
custom-flatpak-sources = Vlastní zdroje pro Flatpak
import-flatpakrepo = Pro přidání vlastního zdroje importujte soubor .flatpakrepo
no-custom-flatpak-sources = Žádné vlastní zdroje pro Flatpak
import = Importovat
no-flatpak = Chybí podpora pro Flatpak
software-repositories = Repozitáře softwaru
appearance = Vzhled
theme = Motiv
