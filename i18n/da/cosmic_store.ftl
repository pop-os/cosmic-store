...
scientific-tools = Videnskabelige værktøjer
productivity-apps = Produktivitetsprogrammer
graphics-and-photography-tools = Grafik- & fotoværktøjer
social-networking-apps = Programmer til sociale netværk
games = Spil
